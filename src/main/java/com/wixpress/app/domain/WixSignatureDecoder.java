...
public class WixSignatureDecoder {
    ...
    public WixSignatureDecoder(ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }



    public final JsonNode decodeSignature(final String signedInstance, final String secretKey) throws Exception {
        // initialization
        ...
        return this.objectMapper.readTree(new String(base64.decode(encodedJson)));
    }
}
